...
<head>
    ...
    if (get_field('header_code')) :
        $other_page = 4;
        the_field('header_code', $other_page); 
    endif;?>
	...
	if ( is_front_page() ) : ?>
    <style>
    .fullscreen-bg.home {background-image: url('<?php the_field('hero_bg'); ?>');}
    @media screen and (max-width: 767px) {.fullscreen-bg.home {background-image: url('<?php the_field('hero_bg_mobile'); ?>');}}
    </style>
    <?php
	endif;
	?>
